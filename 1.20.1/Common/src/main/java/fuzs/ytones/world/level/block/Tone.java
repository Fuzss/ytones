...
public enum Tone {
    ...
    Tone(Ingredient ingredient) {
        this(ingredient, (tone, type) -> new ToneBlock(tone, type, BlockBehaviour.Properties.copy(Blocks.STONE)));
    }
