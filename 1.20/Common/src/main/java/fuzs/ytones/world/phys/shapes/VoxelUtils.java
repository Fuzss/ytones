package fuzs.ytones.world.phys.shapes;
...
public class VoxelUtils {
    ...
    public static VoxelShape rotate(Direction direction, VoxelShape voxelShape) {
        ...
        voxelShape.forAllBoxes((minX, minY, minZ, maxX, maxY, maxZ) -> {
            rotatedShape[0] = Shapes.or(rotatedShape[0], makeCombinedShape(rotate(direction, makeVectors(minX, minY, minZ, maxX, maxY, maxZ))));
        });
